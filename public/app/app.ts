...
@NgModule({
    bootstrap: [App],
    declarations: [App, Home, Register, Login, Landing, Footer, Header, Topwedstrijd, Weekwedstrijd, Search, Evenement, Listing, Cart, MaterializeDirective, AdminOverview],
    imports: [
        BrowserModule,
        HttpModule,
        FormsModule,
